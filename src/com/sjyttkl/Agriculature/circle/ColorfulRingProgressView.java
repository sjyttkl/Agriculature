package com.sjyttkl.Agriculature.circle;
...
public class ColorfulRingProgressView extends View
{
    ...
    private int mBgColor =0xe1e1e100;
    private float mStartAngle = 0;
    private int mFgColorStart = 0x0000FF00;
    private int mFgColorEnd = 0x00CCFF00;
    ...
    public ColorfulRingProgressView(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            mBgColor = a.getColor(R.styleable.ColorfulRingProgressView_bgColor, 0xe1e1e100);
            mFgColorEnd = a.getColor(R.styleable.ColorfulRingProgressView_fgColorEnd, 0x00CCFF00);
            mFgColorStart = a.getColor(R.styleable.ColorfulRingProgressView_fgColorStart, 0x0000FF00);
            ...
            System.out.println("ColorfulRingProgressView" + mStrokeWidth);
        }
        finally
        {
            a.recycle();
